...
function getChatbotResponse(userMessage) {
    ...
    const keywordResponses = {
        ...
        'perdi a senha do painel': 'Claro, aqui está: Pretty8068. Posso ajudar em mais algo?',
        'não era só isso': 'Ok, até a próxima.',
        'perdi a senha da area staffs': 'Claro, aqui está: Staffs8068. Posso ajudar em mais algo?',
        ...
        'palavras chaves': 'Claro aqui está: "perdia senha do painel", "perdi a senha da area staffs", "não era só isso", "sou administrador, mas não tenho acesso ao painel". Por enquanto são essas as palavras chaves.',
